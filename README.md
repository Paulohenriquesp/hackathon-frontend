 # 🎨 Hackathon Frontend - Banco Colaborativo de Recursos Didáticos
  ...
  Interface web moderna em Next.js + TypeScript para sistema de compartilhamento de materiais didáticos com geração de planos
  de aula e atividades por IA.
  ...
  - Integração com backend real (PostgreSQL + Prisma)
  - Sistema de avaliações com comentários
  - Upload de arquivos real
  - Filtros avançados e busca
  - ✨ Geração de planos de aula com IA (OpenAI GPT-4o-mini)
  - ✨ Geração de atividades educacionais com IA
  - Exportação de atividades em Markdown
  - Validação de caracteres em comentários (500 max)
